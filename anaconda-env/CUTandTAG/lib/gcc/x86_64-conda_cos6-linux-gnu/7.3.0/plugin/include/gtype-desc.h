...
#define gt_ggc_m_29hash_table_debug_type_hasher_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_table_debug_type_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_debug_type_hasher_ (void *);
...
#define gt_pch_n_29hash_table_debug_type_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_debug_type_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_debug_type_hasher_ (void *);
...
extern void gt_pch_p_32hash_table_abstract_type_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_29hash_table_debug_type_hasher_
    (void *, void *, gt_pointer_operator, void *);
