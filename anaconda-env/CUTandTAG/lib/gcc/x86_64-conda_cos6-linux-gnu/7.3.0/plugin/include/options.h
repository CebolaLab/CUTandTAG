...
#define MASK_IAMCU (1U << 11)
#define MASK_IEEE_FP (1U << 12)
#define MASK_INLINE_ALL_STRINGOPS (1U << 13)
#define MASK_INLINE_STRINGOPS_DYNAMICALLY (1U << 14)
#define MASK_LONG_DOUBLE_128 (1U << 15)
#define MASK_LONG_DOUBLE_64 (1U << 16)
...
#define MASK_MS_BITFIELD_LAYOUT (1U << 17)
#define OPTION_MASK_ISA_MWAITX (HOST_WIDE_INT_1U << 37)
#define MASK_NO_PUSH_ARGS (1U << 18)
#define MASK_NO_RED_ZONE (1U << 19)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1U << 38)
#define MASK_OMIT_LEAF_FRAME_POINTER (1U << 20)
...
#define MASK_PREFER_AVX128 (1U << 21)
...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1150,            /* -m128bit-long-double */
  OPT_m16 = 1151,                            /* -m16 */
  OPT_m32 = 1152,                            /* -m32 */
  OPT_m3dnow = 1153,                         /* -m3dnow */
  OPT_m3dnowa = 1154,                        /* -m3dnowa */
  OPT_m64 = 1155,                            /* -m64 */
  OPT_m80387 = 1156,                         /* -m80387 */
  OPT_m8bit_idiv = 1157,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1158,             /* -m96bit-long-double */
  OPT_mabi_ = 1159,                          /* -mabi= */
  OPT_mabm = 1160,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1161,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1162,                 /* -maddress-mode= */
  OPT_madx = 1163,                           /* -madx */
  OPT_maes = 1164,                           /* -maes */
  OPT_malign_data_ = 1165,                   /* -malign-data= */
  OPT_malign_double = 1166,                  /* -malign-double */
  OPT_malign_functions_ = 1167,              /* -malign-functions= */
  OPT_malign_jumps_ = 1168,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1169,                  /* -malign-loops= */
  OPT_malign_stringops = 1170,               /* -malign-stringops */
  OPT_mandroid = 1171,                       /* -mandroid */
  OPT_march_ = 1172,                         /* -march= */
  OPT_masm_ = 1173,                          /* -masm= */
  OPT_mavx = 1174,                           /* -mavx */
  OPT_mavx2 = 1175,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1176,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1177,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1178,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1179,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1180,                      /* -mavx512bw */
  OPT_mavx512cd = 1181,                      /* -mavx512cd */
  OPT_mavx512dq = 1182,                      /* -mavx512dq */
  OPT_mavx512er = 1183,                      /* -mavx512er */
  OPT_mavx512f = 1184,                       /* -mavx512f */
  OPT_mavx512ifma = 1185,                    /* -mavx512ifma */
  OPT_mavx512pf = 1186,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1187,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1188,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1189,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1190,                        /* -mbionic */
  OPT_mbmi = 1191,                           /* -mbmi */
  OPT_mbmi2 = 1192,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1193,                  /* -mbranch-cost= */
  OPT_mcld = 1194,                           /* -mcld */
  OPT_mclflushopt = 1195,                    /* -mclflushopt */
  OPT_mclwb = 1196,                          /* -mclwb */
  OPT_mclzero = 1197,                        /* -mclzero */
  OPT_mcmodel_ = 1198,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1199, */                    /* -mcpu= */
  OPT_mcrc32 = 1200,                         /* -mcrc32 */
  OPT_mcx16 = 1201,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1202,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1203,            /* -mdump-tune-features */
  OPT_mf16c = 1204,                          /* -mf16c */
  OPT_mfancy_math_387 = 1205,                /* -mfancy-math-387 */
  OPT_mfentry = 1206,                        /* -mfentry */
  OPT_mfma = 1207,                           /* -mfma */
  OPT_mfma4 = 1208,                          /* -mfma4 */
  OPT_mforce_drap = 1209,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1210,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1211,                       /* -mfpmath= */
  OPT_mfsgsbase = 1212,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1213,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1214, */              /* -mfused-madd */
  OPT_mfxsr = 1215,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1216,             /* -mgeneral-regs-only */
  OPT_mglibc = 1217,                         /* -mglibc */
  OPT_mhard_float = 1218,                    /* -mhard-float */
  OPT_mhle = 1219,                           /* -mhle */
  OPT_miamcu = 1220,                         /* -miamcu */
  OPT_mieee_fp = 1221,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1222,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1223,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1224,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1225,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1226,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1227, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1228,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1229,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1230,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1231,                /* -mlong-double-80 */
  OPT_mlwp = 1232,                           /* -mlwp */
  OPT_mlzcnt = 1233,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1234,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1235,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1236,                  /* -mmitigate-rop */
  OPT_mmmx = 1237,                           /* -mmmx */
  OPT_mmovbe = 1238,                         /* -mmovbe */
  OPT_mmpx = 1239,                           /* -mmpx */
  OPT_mms_bitfields = 1240,                  /* -mms-bitfields */
  OPT_mmusl = 1241,                          /* -mmusl */
  OPT_mmwaitx = 1242,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1243,            /* -mno-align-stringops */
  OPT_mno_default = 1244,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1245,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1246,                  /* -mno-push-args */
  OPT_mno_red_zone = 1247,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1248,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1249,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1250,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1251,                          /* -mpc32 */
  OPT_mpc64 = 1252,                          /* -mpc64 */
  OPT_mpc80 = 1253,                          /* -mpc80 */
  OPT_mpclmul = 1254,                        /* -mpclmul */
  OPT_mpcommit = 1255,                       /* -mpcommit */
  OPT_mpku = 1256,                           /* -mpku */
  OPT_mpopcnt = 1257,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1258,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1259,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1260,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1261,                        /* -mprfchw */
  OPT_mpush_args = 1262,                     /* -mpush-args */
  OPT_mrdpid = 1263,                         /* -mrdpid */
  OPT_mrdrnd = 1264,                         /* -mrdrnd */
  OPT_mrdseed = 1265,                        /* -mrdseed */
  OPT_mrecip = 1266,                         /* -mrecip */
  OPT_mrecip_ = 1267,                        /* -mrecip= */
  OPT_mrecord_mcount = 1268,                 /* -mrecord-mcount */
  OPT_mred_zone = 1269,                      /* -mred-zone */
  OPT_mregparm_ = 1270,                      /* -mregparm= */
  OPT_mrtd = 1271,                           /* -mrtd */
  OPT_mrtm = 1272,                           /* -mrtm */
  OPT_msahf = 1273,                          /* -msahf */
  OPT_msgx = 1274,                           /* -msgx */
  OPT_msha = 1275,                           /* -msha */
  OPT_mskip_rax_setup = 1276,                /* -mskip-rax-setup */
  OPT_msoft_float = 1277,                    /* -msoft-float */
  OPT_msse = 1278,                           /* -msse */
  OPT_msse2 = 1279,                          /* -msse2 */
  OPT_msse2avx = 1280,                       /* -msse2avx */
  OPT_msse3 = 1281,                          /* -msse3 */
  OPT_msse4 = 1282,                          /* -msse4 */
  OPT_msse4_1 = 1283,                        /* -msse4.1 */
  OPT_msse4_2 = 1284,                        /* -msse4.2 */
  OPT_msse4a = 1285,                         /* -msse4a */
  /* OPT_msse5 = 1286, */                    /* -msse5 */
  OPT_msseregparm = 1287,                    /* -msseregparm */
  OPT_mssse3 = 1288,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1289,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1290,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1291,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1292,            /* -mstringop-strategy= */
  OPT_mstv = 1293,                           /* -mstv */
  OPT_mtbm = 1294,                           /* -mtbm */
  OPT_mtls_dialect_ = 1295,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1296,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1297,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1298,                         /* -mtune= */
  OPT_muclibc = 1299,                        /* -muclibc */
  OPT_mveclibabi_ = 1300,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1301,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1302,                    /* -mvzeroupper */
  OPT_mx32 = 1303,                           /* -mx32 */
  OPT_mxop = 1304,                           /* -mxop */
  OPT_mxsave = 1305,                         /* -mxsave */
  OPT_mxsavec = 1306,                        /* -mxsavec */
  OPT_mxsaveopt = 1307,                      /* -mxsaveopt */
  OPT_mxsaves = 1308,                        /* -mxsaves */
  OPT_n = 1309,                              /* -n */
  OPT_no_canonical_prefixes = 1310,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1311,              /* -no-integrated-cpp */
  OPT_no_pie = 1312,                         /* -no-pie */
  OPT_nocpp = 1313,                          /* -nocpp */
  OPT_nodefaultlibs = 1314,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1315,                   /* -nostartfiles */
  OPT_nostdinc = 1316,                       /* -nostdinc */
  OPT_nostdinc__ = 1317,                     /* -nostdinc++ */
  OPT_nostdlib = 1318,                       /* -nostdlib */
  OPT_o = 1319,                              /* -o */
  OPT_p = 1320,                              /* -p */
  OPT_pass_exit_codes = 1321,                /* -pass-exit-codes */
  /* OPT_pedantic = 1322, */                 /* -pedantic */
  OPT_pedantic_errors = 1323,                /* -pedantic-errors */
  OPT_pg = 1324,                             /* -pg */
  OPT_pie = 1325,                            /* -pie */
  OPT_pipe = 1326,                           /* -pipe */
  OPT_posix = 1327,                          /* -posix */
  OPT_print_file_name_ = 1328,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1329,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1330,          /* -print-multi-directory */
  OPT_print_multi_lib = 1331,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1332,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1333,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1334,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1335,               /* -print-prog-name= */
  OPT_print_search_dirs = 1336,              /* -print-search-dirs */
  OPT_print_sysroot = 1337,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1338,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1339,                        /* -profile */
  OPT_pthread = 1340,                        /* -pthread */
  OPT_quiet = 1341,                          /* -quiet */
  OPT_r = 1342,                              /* -r */
  OPT_rdynamic = 1343,                       /* -rdynamic */
  OPT_remap = 1344,                          /* -remap */
  OPT_s = 1345,                              /* -s */
  OPT_save_temps = 1346,                     /* -save-temps */
  OPT_save_temps_ = 1347,                    /* -save-temps= */
  OPT_shared = 1348,                         /* -shared */
  OPT_shared_libgcc = 1349,                  /* -shared-libgcc */
  /* OPT_specs = 1350, */                    /* -specs */
  OPT_specs_ = 1351,                         /* -specs= */
  OPT_static = 1352,                         /* -static */
  OPT_static_libasan = 1353,                 /* -static-libasan */
  OPT_static_libgcc = 1354,                  /* -static-libgcc */
  OPT_static_libgfortran = 1355,             /* -static-libgfortran */
  OPT_static_libgo = 1356,                   /* -static-libgo */
  OPT_static_liblsan = 1357,                 /* -static-liblsan */
  OPT_static_libmpx = 1358,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1359,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1360,               /* -static-libstdc++ */
  OPT_static_libtsan = 1361,                 /* -static-libtsan */
  OPT_static_libubsan = 1362,                /* -static-libubsan */
  /* OPT_std_c__03 = 1363, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1364, */                /* -std=c++0x */
  OPT_std_c__11 = 1365,                      /* -std=c++11 */
  OPT_std_c__14 = 1366,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1367, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1368, */                /* -std=c++1y */
  OPT_std_c__1z = 1369,                      /* -std=c++1z */
  OPT_std_c__98 = 1370,                      /* -std=c++98 */
  OPT_std_c11 = 1371,                        /* -std=c11 */
  /* OPT_std_c1x = 1372, */                  /* -std=c1x */
  /* OPT_std_c89 = 1373, */                  /* -std=c89 */
  OPT_std_c90 = 1374,                        /* -std=c90 */
  OPT_std_c99 = 1375,                        /* -std=c99 */
  /* OPT_std_c9x = 1376, */                  /* -std=c9x */
  OPT_std_f2003 = 1377,                      /* -std=f2003 */
  OPT_std_f2008 = 1378,                      /* -std=f2008 */
  OPT_std_f2008ts = 1379,                    /* -std=f2008ts */
  OPT_std_f95 = 1380,                        /* -std=f95 */
  OPT_std_gnu = 1381,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1382, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1383, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1384,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1385,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1386, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1387, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1388,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1389,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1390,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1391, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1392, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1393,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1394,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1395, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1396, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1397,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1398, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1399, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1400, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1401,                     /* -std=legacy */
  OPT_symbolic = 1402,                       /* -symbolic */
  OPT_t = 1403,                              /* -t */
  OPT_time = 1404,                           /* -time */
  OPT_time_ = 1405,                          /* -time= */
  OPT_tno_android_cc = 1406,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1407,                 /* -tno-android-ld */
  OPT_traditional = 1408,                    /* -traditional */
  OPT_traditional_cpp = 1409,                /* -traditional-cpp */
  OPT_trigraphs = 1410,                      /* -trigraphs */
  OPT_u = 1411,                              /* -u */
  OPT_undef = 1412,                          /* -undef */
  OPT_v = 1413,                              /* -v */
  OPT_version = 1414,                        /* -version */
  OPT_w = 1415,                              /* -w */
  OPT_wrapper = 1416,                        /* -wrapper */
  OPT_x = 1417,                              /* -x */
  OPT_z = 1418,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
