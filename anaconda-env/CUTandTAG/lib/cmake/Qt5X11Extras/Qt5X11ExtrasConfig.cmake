...
set(Qt5X11Extras_VERSION_STRING 5.9.7)
...
if (NOT TARGET Qt5::X11Extras)
    ...
    set(_Qt5X11Extras_OWN_INCLUDE_DIRS "${_qt5X11Extras_install_prefix}/include/qt/" "${_qt5X11Extras_install_prefix}/include/qt/QtX11Extras")
    ...
    foreach(_module_dep ${_Qt5X11Extras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.7 ${_Qt5X11Extras_FIND_VERSION_EXACT}
    ...
    _populate_X11Extras_target_properties(RELEASE "libQt5X11Extras.so.5.9.7" "" )
