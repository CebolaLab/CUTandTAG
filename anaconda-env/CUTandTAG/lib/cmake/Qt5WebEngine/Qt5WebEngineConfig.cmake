...
set(Qt5WebEngine_VERSION_STRING 5.9.7)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(_Qt5WebEngine_OWN_INCLUDE_DIRS "${_qt5WebEngine_install_prefix}/include/qt/" "${_qt5WebEngine_install_prefix}/include/qt/QtWebEngine")
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/qt/QtWebEngine/5.9.7"
        "${_qt5WebEngine_install_prefix}/include/qt/QtWebEngine/5.9.7/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.7 ${_Qt5WebEngine_FIND_VERSION_EXACT}
    ...
    _populate_WebEngine_target_properties(RELEASE "libQt5WebEngine.so.5.9.7" "" )
