...
(bowtie2 --end-to-end --very-sensitive --no-unal --no-mixed --no-discordant --phred33 -l 10 -X 700 -x $bt2idx/hg19.masked -1 "$base"_1.paired.fastq.gz -2 "$base"_2.paired.fastq.gz) 2> "$base".bowtie2 | samtools view -bS - > "$base"_aligned_reads.bam
